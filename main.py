...
<tv generator-info-name="Lourival026">
  ...
  <!-- Canais Jornada nas Estrelas (Etapa 9) -->
  ...
  <!-- Novos Canais Esportes (Etapa 17) -->
  ...
  <!-- Canais Mistérios e Sobrenatural (Etapa 23) -->
